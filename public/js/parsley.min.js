  ...
  ParsleyValidator.prototype = {
    ...
    validators: {
      ...
      type: function (type) {
        ...
        switch (type) {
          ...
          case 'url':
            ...
            break;
          case 'pan':
            assert = new Validator.Assert().Regexp('(^[A-Z]{3}[P][A-Z]\\d{4}[A-Z]+$)', 'i');
            break;
          case 'pan_member':
            assert = new Validator.Assert().Regexp('(^[A-Z]{3}[P|H][A-Z]\\d{4}[A-Z]+$)', 'i');
            break;
          case 'donation_pan':
            assert = new Validator.Assert().Regexp('(^([A-Z]{3}[CPHFATBLJG][A-Z]\\d{4}[A-Z])|([G]{5}\\d{4}[G])+$)', 'i');
            break;
          case 'tan':
            assert = new Validator.Assert().Regexp('(^[A-Z]{4}\\d{5}[A-Z]+$)', 'i');
            break;
          case 'letters_only':
            assert = new Validator.Assert().Regexp('(^[a-zA-Z\ \']+$)', 'i');
            break;
          case 'positive_decimal':
            assert = new Validator.Assert().Regexp('(^[\\+]?(([0-9]+)([\\.,]([0-9]+))?|([\\.,]([0-9]+))?)$)', 'i');
            break;
          case 'onlyLetterNumber':
            assert = new Validator.Assert().Regexp('(^[0-9a-zA-Z \']+$)', 'i');
            break;
          case 'pincode':
            assert = new Validator.Assert().Regexp('(^([1-9][0-9]{5})+$)', 'i');
            break;
          case 'pan_all':
            assert = new Validator.Assert().Regexp('(^[A-Z]{3}[CPHFATBLJG][A-Z]\\d{4}[A-Z]+$)', 'i');
            break;
          case 'onlyLetterNumberNoSp':
            assert = new Validator.Assert().Regexp('(^[0-9a-zA-Z]+$/)', 'i');
            break;
          case 'ifsc':
            assert = new Validator.Assert().Regexp('^[A-Za-z]{4}[0][A-Za-z0-9]+$', 'i');
            break;
          case 'onlyLetterSp':
            assert = new Validator.Assert().Regexp('^[a-zA-Z\ \']+$', 'i');
            break;
          case 'onlyNumberSp':
            assert = new Validator.Assert().Regexp('^[0-9]+$', 'i');
            break;
          case 'username':
            assert = new Validator.Assert().Regexp('^[A-Za-z0-9_.]{6,20}$', 'i');
            break;
          case 'bank_account':
            assert = new Validator.Assert().Regexp('(^[a-zA-Z0-9]*\\d$)', 'i');
            break;
          case 'mobile':
            assert = new Validator.Assert().Regexp('(^[6-9][0-9]{9}$)', 'i');
            break;
          case 'alphanumeric_special':
            assert = new Validator.Assert().Regexp('(^[ a-zA-Z0-9;\',:."/\-]+$)', 'i');
            break;
        case 'pincode_outside':
            assert = new Validator.Assert().Regexp('^\\w+$', 'i');
            break;
        case 'arn_no':
            assert = new Validator.Assert().Regexp('(^[A-Z]{2}\\d{6}[A-Z0-9]{6,7}$)', 'i');
            break;
        case 'gst_no':
            assert = new Validator.Assert().Regexp('(^\\d{2}[A-Z]{5}\\d{4}[A-Z][A-Z0-9]{2,3}$)', 'i');
            break;
          default:
      ...
      notequalto: function (value) {
        return $.extend(new Validator.Assert().notEqualTo(value), {
          priority: 256,
          requirementsTransformer: function () {
            return $(value).length ? $(value).val() : value;
          }
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    digits:			"Enter positive numbers only.",
    alphanum:		"Enter an alphanumeric value.",
	pan:			"Invalid PAN Format.",
	tan:			"Invalid TAN Format.",
	letters_only:	"Letters only.",
	positive_decimal:"Not a valid number.",
	onlyLetterNumber:"Special characters not allowed.",
	pincode:         "Invalid Pincode.",
	onlyLetterNumberNoSp:"No special characters and space allowed.",
	ifsc: "Wrong IFSC format.",
	onlyLetterSp: "Letters only.",
	onlyNumberSp: "Numbers only.",
	donation_pan: "Invalid PAN Format.",
	pan_member: "Invalid PAN Format.",
	username: "Please enter a valid Username!",
	bank_account: "Please enter a valid Bank account number!",
	mobile: "Please enter a valid mobile number!",
	alphanumeric_special: "Special characters not allowed.",
	pan_all:         "Invalid PAN Format.",
	arn_no:         "Invalid Application Reference Number.",
	gst_no:         "Invalid GSTIN Number."
  },
  ...
  minlength:      "This value is too short. It should have minimum %s characters.",
